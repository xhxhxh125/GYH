...
require_once '../../assets/vendor/revolution-slider/revolution/php/flickr/class-flickr.php';

// FLICKR USER URL
$user_url = 'https://www.flickr.com/photos/wyncliffe';

// API DATA
$api_key = 'c2da044a23ffad3906e949647b302b5c';
...
<html lang="en" class="font-primary">
  <head>
    <title>Flickr Stream | Unify - Responsive Website Template</title>
        ...
        <div id="rev_slider" class="rev_slider fullwidthabanner" style="display: none;"
          ...
          <ul>
            <?php foreach ($photos as $photo) : ?>
              <li data-index="rs-<?php echo $photo->id; ?>"
                  data-transition="scaledownfrombottom"
                  data-slotamount="7"
                  data-easein="default"
                  data-easeout="default"
                  data-masterspeed="1500"
                  data-thumb="<?php echo $photo->url_l; ?>"
                  data-rotate="0"
                  ...
                  data-param1="<?php echo $photo->datetaken; ?>">
                <img class="rev-slidebg" src="assets/img/dummy.png" alt="Image description"
                     data-lazyload="<?php echo $photo->url_l; ?>"
                     data-bgposition="center center"
                     data-bgfit="cover"
                     data-bgrepeat="no-repeat">
                <!-- LAYER NR. 1 -->
                <a class="tp-caption WebProduct-Menuitem" href="<?php echo 'http://flic.kr/p/' . TP_flickr::base_encode($photo->id); ?>" target="_blank" style="z-index: 5; font-size: 20px; line-height: 30px; color: rgba(255, 255, 255, 1); font-family: Raleway; background-color: rgba(0, 0, 0, .5); padding: 3px 5px 3px 8px; border-radius: 10px;"
