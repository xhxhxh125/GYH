...
require_once '../../assets/vendor/revolution-slider/revolution/php/instagram/class-instagram.php';

// INSTAGRAM USER
$search_user_id = '5392484639';

// API DATA
$api_key = '5392484639.1677ed0.072ce8f684364dbf898aeeac1d0d34ab';
...
<html lang="en" class="font-primary">
  <head>
    <title>Instagram Carousel | Unify - Responsive Website Template</title>
  ...
  <body>
    <main>
      ...
      <div id="rev_slider_wrapper" class="rev_slider_wrapper fullwidthbanner-container" style="margin:0px auto;background-color:#111111;padding:0px;margin-top:0px;margin-bottom:0px;background-image:url(assets/img/webproduct_darkbg3.jpg);background-repeat:no-repeat;background-size:cover;background-position:center center;">
        ...
        <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0">
          <ul>  <!-- SLIDE  -->
            ...
            foreach ($photos as $photo) :
              ...
              <li data-index="rs-<?php echo $photo->created_time; ?>"
                  data-transition="incube-horizontal"
                  data-slotamount="1"
                  data-easein="default"
                  ...
                  data-param1="<?php echo $photo->created_time; ?>">
                ...
                <!-- LAYER NR. 1 -->
                <a id="slide-<?php echo $photo->created_time; ?>-layer-2" class="tp-caption Instagram-Caption tp-resizeme" href="<?php echo $photo->link; ?>" target="new" style="z-index: 5; white-space: nowrap; font-size: 13px; line-height: 20px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto; background-color: rgba(0, 0, 0, .5); padding: 5px 10px 5px 10px; border-radius: 0;"
                  ...
                  <i class="fa fa-pencil"></i> &nbsp; <?php echo $photo->user->username; ?> &nbsp; &nbsp;
                  <i class="fa fa-heart"></i> &nbsp; <?php echo $photo->likes->count; ?>
                </a>
              </li>
            <?php endforeach; ?>
          </ul>
