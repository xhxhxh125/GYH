...
require_once '../../assets/vendor/revolution-slider/revolution/php/youtube/class-youtube.php';

// YOUTUBE PLAYLIST ID
$playlist_id = 'PLWQAcLwq0Bfm1YbQRslSfrNwZR_lp0e_H';

// API DATA
$api_key = 'AIzaSyAtt1z99GtrHZt_IcnK-wryNsQ30A112J0';
$channel_id = 'UCElfeWPYUdt4LypQ8BkxV-Q';
...
<html lang="en" class="font-primary">
  <head>
    <title>Youtube Stream | Unify - Responsive Website Template</title>
  ...
  <body>
    <main>
      ...
      <div id="rev_slider_wrapper" class="rev_slider_wrapper fullwidthbanner-container" style="background-color: #000; padding: 0; margin: 0 auto;">
          ...
          <ul>
            <?php foreach ($videos as $video) : ?>
              <li data-index="rs-<?php echo $video->snippet->resourceId->videoId; ?>"
                  ...
                  data-thumb="<?php echo $video->snippet->thumbnails->medium->url; ?>"
                  data-rotate="0"
                  data-fstransition="fade"
                  data-fsmasterspeed="1500"
                  data-fsslotamount="7"
                  data-saveperformance="off"
                  data-title="<?php echo $video->snippet->title; ?>"
                  data-param1="<?php echo $video->snippet->publishedAt; ?>">
                <img class="rev-slidebg" src="<?php echo $video->snippet->thumbnails->maxres->url; ?>" alt="Image description"
                     data-bgposition="center center"
                     data-bgfit="100% 0"
                     data-bgrepeat="no-repeat">

                <!-- LAYER NR. 1 -->
                <div id="slide-<?php echo $video->snippet->resourceId->videoId; ?>-layer-2" class="tp-caption tp-resizeme tp-videolayer" style="z-index: 5; padding: 0; border-radius: 0;"
                     data-x="center"
                     data-hoffset=""
                     data-y="center"
                     data-voffset=""
