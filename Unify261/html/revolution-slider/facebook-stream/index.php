...
require_once '../../assets/vendor/revolution-slider/revolution/php/facebook/class-facebook.php';
$facebook = new TP_facebook();

// FACEBOOK PAGE
$user_id = $facebook->get_user_from_url('https://www.facebook.com/oleg.sevruk.1');

// API DATA
// Create App ID and Secret -> https://developers.facebook.com/apps/?action=create
$app_id = '1586229021671350';
$app_secret = '94e2cfeb6263c098096d53d1bbfbe130';
...
<html lang="en" class="font-primary">
  <head>
    <title>Facebook Stream | Unify - Responsive Website Template</title>
  ...
  <body>
    <main>
      ...
      <div id="rev_slider_wrapper" class="rev_slider_wrapper fullwidthbanner-container" style="background-color: #ddd; padding: 0; margin: 0 auto;">
          ...
          <ul>
            ...
            foreach ($post_feed as $post) :
              if ($post->status_type != "wall_post") :
                ...
                <li data-index="rs-<?php echo $post->id; ?>"
                    ...
                    data-param2="<?php echo $post->message; ?>">
                  <img class="rev-slidebg" src="../../assets/images/dummy.png" alt="Image description"
                  ...
                  <!-- LAYER NR. 1 -->
                  <div id="slide-<?php echo $post->id; ?>-layer-1" class="tp-caption Facebook-Likes" style="z-index: 5; min-width: 90px; max-width: 90px; min-height: 32px; max-height: 32px; white-space: normal; font-size: 15px; line-height: 22px; color: rgba(255, 255, 255, 1); text-align: center; background-color: rgba(59, 89, 153, 1); padding: 5px 15px; border-radius: 0;"
                       data-x="10"
                       data-y="bottom"
                       data-voffset="10"
                       data-width="['90']"
                       ...
                       data-responsive="off">
                    <i class="fa fa-thumbs-o-up"></i> <?php echo isset($post->likes->data) ? sizeof($post->likes->data) : 0; ?>
                  </div>

                  <!-- LAYER NR. 2 -->
                  <a id="slide-<?php echo $post->id; ?>-layer-2" class="tp-caption Facebook-Likes" href="<?php echo $post->link; ?>" target="_blank" style="z-index: 6; min-width: 45px; max-width: 45px; min-height: 32px; max-height: 32px; white-space: normal; font-size: 15px; line-height: 22px; color: rgba(0, 0, 0, 1); text-align: center; background-color: rgba(255, 255, 255, 1); padding: 5px 15px; border-radius: 0;"
                     data-x="105"
                     data-y="bottom"
                     data-voffset="10"
                     data-width="['45']"
